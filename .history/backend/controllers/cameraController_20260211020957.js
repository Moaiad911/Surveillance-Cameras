 ...
 * @property {(id: string) => Promise<Camera | null>} findById
 * @property {() => Promise<Camera[]>} findAll
 * @property {(camera: Camera) => Promise<Camera>} create
 * @property {(id: string, camera: Object) => Promise<Camera | null>} update
