...
export class CameraService {
    ...
    async getAllCameras(userId?: string): Promise<Camera[]> {
        return this.cameraRepo.findAll(userId);
    }

    async getCameraById(id: string, userId?: string): Promise<Camera | null> {
        return this.cameraRepo.findById(id, userId);
    }
    ...
    async updateCamera(id: string, data: Partial<Camera>, userId?: string): Promise<Camera | null> {
        return this.cameraRepo.update(id, data, userId);
    }
